...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle:
        "We combine decades of financial expertise with modern digital strategy to help your business thrive.",
      cta: "Contact Us",
    },
    services: {
      title: "Our Services",
      accounting: {
        ...
        details:
          "Comprehensive accounting services including VAT reporting, payroll, and compliance for small to medium businesses.",
      },
      it: {
        title: "IT & Product Consulting",
        desc: "We guide your digital journey, from product strategy and MVP development to AI readiness.",
        details:
          "Expert guidance on product strategy, roadmap development, and workflow automation.",
      },
      business: {
        title: "Business & Operations",
        desc: "We help you optimize processes, improve efficiency, and lead your team through transformation.",
        details:
          "Efficiency improvements, process redesign, and operational structure optimization.",
      },
  ...
  et: {
    ...
    hero: {
      ...
      subtitle:
        "Ühendame aastakümnete pikkuse finantskogemuse kaasaegse digitaalse strateegiaga, et aidata teie ettevõttel õitseda.",
      cta: "Võtke ühendust",
    },
    services: {
      title: "Meie Teenused",
      accounting: {
        ...
        details:
          "Laiaulatuslikud raamatupidamisteenused, sealhulgas käibemaksuaruandlus, palgaarvestus ja vastavus.",
      },
      it: {
        ...
        details:
          "Asjatundlik nõu tootestrateegia, tegevuskava arendamise ja töövoogude automatiseerimise kohta.",
      },
      business: {
        ...
        details:
          "Tõhususe parandamine, protsesside ümberkujundamine ja tegevusstruktuuri optimeerimine.",
      },
